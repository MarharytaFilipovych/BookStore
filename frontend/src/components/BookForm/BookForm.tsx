...
const LANGUAGE_OPTIONS: Language[] = ['ENGLISH', 'SPANISH', 'FRENCH', 'GERMAN', 'UKRAINIAN', 'JAPANESE', 'OTHER'];

const AGE_GROUP_OPTIONS: AgeGroup[] = ['CHILD', 'TEEN', 'ADULT', 'OTHER'];
...
const GENRE_OPTIONS = [
    ...
    'Art', 'Travel', 'Cooking', 'Health', 'Business', 'Education'
];
...
export const BookForm: React.FC<BookFormProps> = ({ onSubmit, onCancel, initialData = {} }) => {
    ...
    const validateForm = (): boolean => {
        ...
        if (!formData.publication_date) newErrors.publication_date = 'Publication date is required';
            ...
            if (new Date(formData.publication_date) >  new Date()) newErrors.publication_date = 'Publication date cannot be in the future';
        }
